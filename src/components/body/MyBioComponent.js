  ...
  return (
    <div className='myBio-container'>
      <section id='myBio-item'>
        <p>
          Graduated at San Jose State University with a Finance/Economics degree and spent 5 years in Corporate Finance
          but decided to make a career switch to become a Frontend developer.
        </p>
        <p>
